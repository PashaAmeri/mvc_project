                            ...
                            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        foreach ($not_verify_doctors as $doctors) {
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="ml-4">
                                                            <div class="text-sm leading-5 font-medium text-gray-900"><?= $doctors['name'] ?>
                                                            </div>
                                                            <div class="text-sm leading-5 text-gray-500"><?= $doctors['email'] ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                    <form action="" method="POST">
                                                        <button value="<?= $doctors['ID'] ?>" name="verify" type="submit" class="text-indigo-600 hover:text-indigo-900">Verify</button>
                                                    </form>
                                                </td>
                                            </tr>
