...
<div class="min-w-screen min-h-screen bg-gray-300 flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-1/2 overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <form class="w-full py-10 px-5 md:px-10" method="POST" action="">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900">CREATE AN ACCOUNT</h1>
                ...
                <div>
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" name="name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John Smith">
                            </div>
                        </div>
                        <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input name="email" type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="something@example.com">
                            </div>
                        </div>

                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="text-xs font-semibold px-1">Register as:</label>
                            <select name="role" class="form-select form-select-lg w-full pl-10 pr-3 py-2 rounded-lg border-2 bg-white border-gray-200 outline-none focus:border-indigo-500">
                    ...
                    <div class="flex -mx-3">
                        ...
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                <input name="con_password" type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
